...
export default class DatabaseConnector {
    ...
    createTables(db) {
        db.exec(`
            create table brand (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                name varchar(28) NOT NULL,
                country varchar(20) NOT NULL);
        
            create table model (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
            ...
            insert into modelVersion (brandId, modelId, bodyTypeId, productionStart,
                                      productionEnd, engineCapacity, power, fuelTypeId, productionYear) values 
                                            (1, 1, 2, '1993-02-01', '2018-06-22', 1.2, 60, 1, 2004),
